...
public class ActivityCitas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                doctor.setName(dataSnapshot.child("Doctor").child(id_doctor).child("name").getValue(String.class));
    ...
    public void saveOnFirebase(){
        ...
        citasPaciente.setName_doc("Dr. "+doctor.getName());
        citasPaciente.setMotive(motivo.getText().toString());
